...
def options_menu(screen, screen_width, screen_height, menu_font, colors, clock=None, title_font=None):
    ...
    while True:
        ...
        settings_rect = pygame.Rect(cx - back_text.get_width()//2 - 10, back_y - 10,
        ...
        pygame.draw.rect(screen, GOLD, settings_rect, border_radius=12)
        ...
        screen.blit(settings_text, (cx - settings_text.get_width()//2, fullscreen_y + 60))
